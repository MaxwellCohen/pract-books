...
export function Select({ children, className, ...props }: JSX.IntrinsicElements['select']) {
  return (
    <span className="relative block min-w-0">
      ...
      <ChevronDownIcon className="text-muted pointer-events-none absolute top-1/2 right-2.5 size-4 -translate-y-1/2" />
    </span>
  );
}
