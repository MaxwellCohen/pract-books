...
function Icon({ children, className, fill }: IconProps & { children: ComponentChildren; fill?: string }) {
  return (
    <svg
      aria-hidden
...
export function StarIcon(props: IconProps) {
  return (
    <svg aria-hidden className={cn('size-4', props.className)} fill="currentColor" stroke="none" viewBox="0 0 24 24">
...
export function SpinnerIcon(props: IconProps) {
  return (
    <svg aria-hidden className={cn('size-4 animate-spin', props.className)} fill="none" viewBox="0 0 24 24">
